...
## Attuned 1.5.7+forge.mc1.21.1 - Forge Updraft Flight Patch
...
### Changed
- **Forge release metadata** - Modrinth and CurseForge uploads use Forge: Minecraft 1.21.1 - Attuned 1.5.7+forge.mc1.21.1 as the public display name, and CurseForge no longer declares Fabric API for Forge files.
...
## Attuned 1.5.6+mc1.21.1 - Fabric Artifact Size Patch

### Changed
- **Fabric release naming** - Modrinth and CurseForge uploads now use Fabric: Minecraft 1.21.1 - Attuned 1.5.6+mc1.21.1 as the public version display name so future Forge and NeoForge files can sit beside Fabric builds without ambiguity.
- **Patch-only artifact refresh** - rebuilt the Minecraft 1.21.1 Fabric jar from the already-verified gameplay code with the release-size optimization applied; this patch does not add gameplay content or rebalance Foci.
...
### Fixed
- Widened Fabric Loader and Fabric API dependency metadata to the compatibility floor for Minecraft 1.21.1 so older valid Fabric installs are not rejected unnecessarily.
...
### Changed
- Started a dedicated Minecraft 1.21.1 maintenance artifact from the verified 1.21.x compatibility branch.
...
- Release metadata targets Minecraft 1.21.1, Java 21, Fabric Loader 0.19.3, and Fabric API 0.116.12+1.21.1.

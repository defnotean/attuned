...
### Changed
- **Forge release metadata** - Modrinth and CurseForge uploads use Forge: Minecraft 26.2 - Attuned 1.5.7+forge.mc26.2 as the public display name, and CurseForge no longer declares Fabric API for Forge files.

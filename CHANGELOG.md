...
## Attuned 1.5.7+forge.mc26.1.2 - Forge Updraft Flight Patch
...
### Changed
- **Forge release metadata** - Modrinth and CurseForge uploads use Forge: Minecraft 26.1.2 - Attuned 1.5.7+forge.mc26.1.2 as the public display name, and CurseForge no longer declares Fabric API for Forge files.
...
## Attuned 1.5.6+mc26.1.2 - Fabric Artifact Size Patch

### Changed
- **Fabric release naming** - Modrinth and CurseForge uploads now use Fabric: Minecraft 26.1.2 - Attuned 1.5.6+mc26.1.2 as the public version display name so future Forge and NeoForge files can sit beside Fabric builds without ambiguity.
- **Patch-only artifact refresh** - rebuilt the Minecraft 26.1.2 Fabric jar from the already-verified gameplay code with the release-size optimization applied; this patch does not add gameplay content or rebalance Foci.
...
- This maintenance release targets Minecraft 26.1.2; the `latest` release line targets newer Minecraft versions separately.

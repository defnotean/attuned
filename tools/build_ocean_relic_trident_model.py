...
def main() -> None:
	...
	base_model = build_model(elements, base_display(),
		"Generated by tools/build_ocean_relic_trident_model.py from the image-generated Ocean Relic Trident palette")
...
def build_report(elements: list[dict[str, Any]]) -> dict[str, Any]:
	...
	return {
		...
		"strategy": "curated_trident_silhouette_from_image_generated_palette",

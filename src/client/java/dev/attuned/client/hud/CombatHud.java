...
public final class CombatHud {
	...
	private static final ResourceLocation FURY_SPRITE = new ResourceLocation(Attuned.MOD_ID, "hud/affinity_fury");
	private static final ResourceLocation BASTION_SPRITE = new ResourceLocation(Attuned.MOD_ID, "hud/affinity_bastion");
	private static final ResourceLocation ZEPHYR_SPRITE = new ResourceLocation(Attuned.MOD_ID, "hud/affinity_zephyr");
	private static final ResourceLocation HOLY_SPRITE = new ResourceLocation(Attuned.MOD_ID, "hud/affinity_holy");
	private static final ResourceLocation TIDE_SPRITE = new ResourceLocation(Attuned.MOD_ID, "hud/affinity_tide");
	private static final ResourceLocation FORGE_SPRITE = new ResourceLocation(Attuned.MOD_ID, "hud/affinity_forge");
	private static final ResourceLocation VERDANT_SPRITE = new ResourceLocation(Attuned.MOD_ID, "hud/affinity_verdant");
	private static final ResourceLocation UMBRAL_SPRITE = new ResourceLocation(Attuned.MOD_ID, "hud/affinity_umbral");
	private static final ResourceLocation DISCORD_SPRITE = new ResourceLocation(Attuned.MOD_ID, "hud/affinity_discord");
	private static final ResourceLocation NEUTRAL_SPRITE = new ResourceLocation(Attuned.MOD_ID, "hud/affinity_neutral");
	private static final ResourceLocation TARGET_RING_SPRITE = new ResourceLocation(Attuned.MOD_ID, "hud/hud_target_ring");
	private static final ResourceLocation EMPOWERED_RING_SPRITE =
		new ResourceLocation(Attuned.MOD_ID, "hud/hud_empowered_ring");
	private static final ResourceLocation NEUTRALIZED_OVERLAY_SPRITE =
		new ResourceLocation(Attuned.MOD_ID, "hud/hud_neutralized_overlay");
	private static final ResourceLocation LINK_NEUTRAL_SPRITE = new ResourceLocation(Attuned.MOD_ID, "hud/hud_link_neutral");
	private static final ResourceLocation LINK_EMPOWERED_SPRITE =
		new ResourceLocation(Attuned.MOD_ID, "hud/hud_link_empowered");
	private static final ResourceLocation LINK_NEUTRALIZED_SPRITE =
		new ResourceLocation(Attuned.MOD_ID, "hud/hud_link_neutralized");
	private static final ResourceLocation HUD_BACKPLATE_TEXTURE =
		new ResourceLocation(Attuned.MOD_ID, "textures/gui/hud_backplate.png");
	...
	private static final ResourceLocation RESONANCE_TRACK_TEXTURE =
		new ResourceLocation(Attuned.MOD_ID, "textures/gui/sprites/hud/hud_resonance_track.png");
	private static final ResourceLocation RESONANCE_FILL_TEXTURE =
		new ResourceLocation(Attuned.MOD_ID, "textures/gui/sprites/hud/hud_resonance_fill.png");

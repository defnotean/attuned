...
public final class PartyHud {
	...
	private static Component memberSummary(CircleSnapshotPayload.Member member) {
		if (member.role().isBlank()) {
			return new net.minecraft.network.chat.TranslatableComponent("party.attuned.member.summary",
				member.stance(), member.activeCount(), member.dormantCount());
		}
		return new net.minecraft.network.chat.TranslatableComponent("party.attuned.member.summary.role",
	...
	private static void drawInvitePrompt(GuiGraphics graphics, Font font,
		...
		drawTrimmedText(graphics, font, new net.minecraft.network.chat.TranslatableComponent("party.attuned.invite.title"),
			x + TEXT_X, y + 3, HEADER_TEXT, INVITE_TEXT_MAX_W);
		drawTrimmedText(graphics, font, new net.minecraft.network.chat.TranslatableComponent("party.attuned.invite.sender", sender, circle),
			x + TEXT_X, y + 13, MEMBER_TEXT, INVITE_TEXT_MAX_W);
		drawTrimmedText(graphics, font, new net.minecraft.network.chat.TranslatableComponent("party.attuned.invite.size", size),
			x + TEXT_X, y + 23, MEMBER_TEXT, INVITE_SIZE_MAX_W);
		drawTrimmedText(graphics, font, new net.minecraft.network.chat.TranslatableComponent("party.attuned.invite.expires", seconds),
			x + TEXT_X + 54, y + 23, MEMBER_TEXT, INVITE_EXPIRES_MAX_W);
		drawTrimmedText(graphics, font, new net.minecraft.network.chat.TranslatableComponent("party.attuned.invite.accept", accept),
	...
	private static void drawPing(GuiGraphics graphics, Font font,
		...
		drawTrimmedText(graphics, font, new net.minecraft.network.chat.TranslatableComponent("party.attuned.ping.title", sender),
			x + TEXT_X, y + 3, HEADER_TEXT, PING_TEXT_MAX_W);
		drawTrimmedText(graphics, font, new net.minecraft.network.chat.TranslatableComponent("party.attuned.ping.location", location),
			x + TEXT_X, y + 14, MEMBER_TEXT, PING_TEXT_MAX_W);
		drawTrimmedText(graphics, font, new net.minecraft.network.chat.TranslatableComponent("party.attuned.ping.expires", seconds),

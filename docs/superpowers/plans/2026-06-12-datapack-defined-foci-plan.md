...
- [ ] **Version + changelog.** Bump `mod_version` in `gradle.properties` to the Datapack-Foci release version; confirm `CHANGELOG.md` has the complete section (it gates the publish tooling).

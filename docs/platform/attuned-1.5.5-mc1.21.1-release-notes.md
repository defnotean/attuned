...
- **Updraft release carried forward** - Attuned 1.5.5+mc1.21.1 includes the 1.5.1 Updraft Focus, smoother boost/brake controls, flight feedback, and PvP exhaustion safeguard.
...
- Refreshed dependency locking, Gradle verification metadata, version-profile docs, and release upload metadata for the Minecraft 1.21.1 maintenance line.

...
Attuned is a Fabric accessory mod for Minecraft 1.21.1 built around deliberate Focus loadouts, visible counterplay, and progression through attunement.
...
- Attuned 1.5.5+mc1.21.1 brings the gameplay-polish backport to Minecraft 1.21.1 with Circles, Deep Lanterns, shared contribution rules, expanded build metadata, and the 1.5.1 Updraft flight controls.

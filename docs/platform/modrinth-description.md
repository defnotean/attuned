...
Attuned is a Fabric accessory mod for **Minecraft 1.19.4** built around deliberate Focus loadouts, visible counterplay, and progression through attunement.
...
- **Attuned 1.5.5+mc1.19.4** brings the gameplay-polish backport to Minecraft 1.19.4 with Circles, Deep Lanterns, shared contribution rules, expanded build metadata, and the 1.5.1 Updraft flight controls.

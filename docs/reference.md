...
| `attuned:wellspring_swim` | `focus_behavior/wellspring_swim.json` | 1.20.6 swim fallback: Dolphin's Grace while underwater. |
| `attuned:current_runner_swim` | `focus_behavior/current_runner_swim.json` | 1.20.6 swim fallback: Dolphin's Grace while underwater. |

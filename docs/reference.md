...
| `attuned:wellspring_swim` | `focus_behavior/wellspring_swim.json` | 1.19.2 swim fallback: Dolphin's Grace while underwater. |
| `attuned:current_runner_swim` | `focus_behavior/current_runner_swim.json` | 1.19.2 swim fallback: Dolphin's Grace while underwater. |
| `attuned:ebbstride` | `EbbstrideBehavior` | 1.19.2 fall-damage fallback: scales fall damage to match the newer fall-damage-multiplier attribute. |

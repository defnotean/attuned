...
| Focus Reliquary | Leather pouch around an amethyst shard | A stack-bound bag for spare Foci. Its screen moves Foci to and from the six equipped slots (left-click equips, right-click stores, shift+left-click returns a Focus to the inventory) and saves, applies, and deletes equipped-loadout presets. |

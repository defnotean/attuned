...
## Current release - Attuned 1.5.5+mc1.20.6

- **Gameplay-polish backport** - Circles, Deep Lanterns, shared contribution rules, expanded build metadata, action-bar priority routing, and Updraft flight polish are now available on the Minecraft 1.20.6 maintenance line.
...
- **Large patch by design** - this release includes the code, assets, docs, gallery updates, example datapack entries, compatibility shims, and regression tests needed to ship the new systems cleanly on 1.20.6.

...
An accessory mod for **Minecraft 1.19.2** (Fabric).
...
## Current release - Attuned 1.5.5+mc1.19.2

- **Gameplay-polish backport** - Circles, Deep Lanterns, shared contribution rules, expanded build metadata, action-bar priority routing, and Updraft flight polish are now available on the Minecraft 1.19.2 maintenance line.
...
- **Large patch by design** - this release includes the code, assets, docs, gallery updates, example datapack entries, compatibility shims, and regression tests needed to ship the new systems cleanly on 1.19.2.
...
Minecraft 1.19.2, Fabric Loader 0.18.4+, Fabric API 0.77.0+1.19.2
